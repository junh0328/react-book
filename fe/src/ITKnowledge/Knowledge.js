...
const Knowledge = () => {
	return (
		<div className="it__wrap">
			...
			<div className="section6">프레임워크와 리아브러리는 뭐가 다른 거죠?</div>
			<p>
				여러분이 도넛 가게를 창업한다고 생각해봅시다. 먼저 도넛이 있어야 합니다.
				우유랑 밀가루와 설탕을 구매합니다. 이제 섞어보죠. 열심히 만들어봅니다.
				그리고 마슬 보죠. 맛이 없군요. 버립니다. 새롭게 다시 만들어봅니다. 또 뭘
				해야 할까요? 브랜딩이 필요합니다. 이름도 지어야 하고, 디자인도 해야
				합니다. 할 일이 어마어마하게 많군요. 하지만 이보다 훨씬 빠르게 도넛
				가게를 차릴 수 있는 방법이 있습니다. 바로 던킨도너츠의 프랜차이즈로
				들어가면 됩니다. 던킨도너츠에서 도넛은 물론이고 포스 단말기, 디자인,
				브랜드, 가구 등을 모두 제공합니다.
			</p>
			<p>
				프레임워크는 '던킨도너츠'입니다. iOS 애플리케이션을 만든다고 생각해보죠.
				이때 개발자는 버튼부터 한 땀 한 땀 코딩하지 않습니다. 버튼은 이미 애플이
				만들어 놨습니다. 그렇게 만들어놓은 코드를 개발자가 사용합니다. 그럼
				애플은 왜 프레임워크를 만들어 놨을까요?
			</p>
			<p>
				애플은 앱스토어에 좋은 앱들이 올라오길 바랍니다. 좋은 앱들이 많으면 이
				앱들을 사용하기 위해 아이폰을 살테니까요. 그런데 만약 애플 앱을 만드는데
				버튼 하나하나를 코딩해 10년이 걸린다면 어떨까요? iOS가 2007년에
				등장했으니 적어도 2017년까지는 앱이 만들어지지 못했을 겁니다. 하지만
				앱스토어에는 이미 수많은 애플리케이션들이 있죠. 애플이 제공해주는
				프레임워크 덕분입니다.
			</p>
			<p>
				{' '}
				iOS, MacOS, WatchOS 등의 애플의 애플리케이션을 개발하기 위해서는 Swift
				혹은 Objective-C 라는 언어를 사용해야 합니다. 여기에 애플에서 제공해주는
				프레임워크인 코코아를 사용하면 애플의 애플리케이션을 더 쉽고, 빠르게
				만들 수 있습니다. 안드로이드 또한 마찬가지입니다. 자바 혹은 코틀린이라는
				언어를 사용하죠. 그리고 안드로이드 프레임워크를 사용하면 안드로이드에
				올라가는 애플리케이션을 쉽게 만들 수 있습니다.
			</p>
			<p>
				그럼 라이브러리는 뭘까요? 라이브러리도 다른 사람들이 만들어놓은 코드를
				이용한다는 측면에서 프레임워크와 같습니다. 하지만 프레임워크가 더 큰
				개념입니다. 각종 라이브러리와 코드들이 모여 프레임워크가 됩니다. 더불어
				한 프로젝트에서 프레임워크는 하나만 쓸 수 있습니다. 한 자동차를
